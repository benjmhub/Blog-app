...
export default async function Post({ params }: { params: { postId: string } }) {
    ...
    return (
        <main className="prose prose-xl prose-slate dark:prose-invert  mx-auto  bg-white/30 backdrop-blur-md shadow-xl rounded-3xl h-auto lg:w-[900px] md:w-[550px] xxsm:w-[340px] px-10 pt-16 pb-10">
